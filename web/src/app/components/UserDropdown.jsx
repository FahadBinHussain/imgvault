  ...
  return (
    <div ref={rootRef} className={`relative ${className}`}>
      ...
      >
        ...
        />
        <ChevronDown className={`w-4 h-4 text-dark-300 transition-transform ${open ? 'rotate-180' : ''}`} />
      </button>

      {open && (
        <div
          className="absolute right-0 mt-2 w-52 rounded-xl border border-white/25 shadow-2xl p-2 z-[9999] overflow-hidden backdrop-blur-none isolate"
          style={{
